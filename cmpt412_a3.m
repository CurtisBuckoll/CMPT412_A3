...
unknown1 = mat2gray(im2double(imread('./real/cone2-lamp1.tif')));
unknown2 = mat2gray(im2double(imread('./real/cone2-lamp3.tif')));
unknown3 = mat2gray(im2double(imread('./real/cone2-lamp2.tif')));
